...
####################################################################
# From test_attachments.py
####################################################################

#     def test_attach_url_to_proof(self, smart_setup):
#         smart = smart_setup['smart']
#         url = smart.models.Proof({
#             'name': 'find stuff',
#             'description': 'Maybe you have heard of this.',
#             'url': 'http://www.google.com/',
#             'attachment_type': 'LINK'
#         })
#         action = smart_setup['proof_b'].attach_url(url)
...
#################################################################### From test_discussions.py
    ...
    def test_get_row_proofs(self, smart_setup):
        smart = smart_setup['smart']
