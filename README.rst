...
The SDK API documentation can be viewed online at
...
4. Refer to the `Smartsheet API
   Documentation <https://smartsheet-platform.github.io/api-docs/?python>`__
   for dozens of Python SDK usage examples.
...
**1.0.1 (Jan 7, 2016)** \* Fix package version in User-Agent string
