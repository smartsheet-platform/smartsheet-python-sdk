...
# Imports go here  ### Verify imports ###
...
###################################################################################################
    ...
    #         prepped_request = self._base.prepare_request(_op)
            response = 'Hello World - Single Proof' # self._base.request(prepped_request, expected, _op)

            return response

    def list_all_proofs:
        """Fetch all the Proofs from specified sheet.
        ...
        Returns:
            Proofs list
        """
        _op = fresh_operation('list_all_proofs')
        _op['method'] = 'GET'
        _op['path'] = '/sheets/' + str(sheet_id) + '/proofs/'

        expected = 'Proofs'
        response = 'Hello World - List of Proofs'
